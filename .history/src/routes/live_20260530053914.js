...
async function cleanupOldLives() {
  try {
    ...
    // Ended lives older than 24h — skip flagged ones
    ...
    // Stuck lives (never ended) older than 24h — skip flagged ones
...
async function cleanupExpiredPulse() {
  try {
    ...
    // Only delete non-flagged expired posts
    ...
    // Log how many are being preserved due to flagging
