...
const MALE_BOTS = [
  {
    ...
    sex: "Man",
    sexInterest: "Women",
    bio: "Chi-town born and raised 🏙️ Love the Bulls, good food, and good vibes.",
  },
  {
    name: "DeShawn",
    age: 29,
    ...
    sex: "Man",
    sexInterest: "Women",
    bio: "South side all day. Looking for someone real to vibe with 🔥",
  },
  {
    name: "Jordan",
    age: 24,
    ...
    sex: "Man",
    sexInterest: "Women",
    bio: "Gym, music, and deep dish pizza. Let's see where this goes 😎",
  },
  {
    name: "Khalil",
    age: 31,
    ...
    sex: "Man",
    sexInterest: "Women",
    bio: "Old soul with new energy. Love late night drives and good conversations.",
  },
  {
    name: "Tyrese",
    age: 27,
    city: "Chicago",
    sex: "Man",
    sexInterest: "Everyone",
    bio: "Foodie, traveler, music lover. Chicago is home but the world is my playground ✈️",
  },
  {
    name: "Aaron",
    age: 23,
    ...
    sex: "Man",
    sexInterest: "Women",
    bio: "Just a chill guy from the south suburbs looking for genuine connections 💯",
  },
  {
    name: "Elijah",
    age: 28,
    ...
    sex: "Man",
    sexInterest: "Women",
    bio: "Engineer by day, chef by night 🍳 Looking for my person.",
  },
  {
    name: "Damien",
    age: 32,
    ...
    sex: "Man",
    sexInterest: "Women",
    bio: "Father, hustler, dreamer. Real recognize real out here.",
  },
];
...
const FEMALE_BOTS = [
  {
    ...
    sex: "Woman",
    sexInterest: "Men",
    bio: "Pilates, brunch, and Sunday drives 🌸 Looking for someone who matches my energy.",
  },
  {
    name: "Aaliyah",
    age: 28,
    ...
    sex: "Woman",
    sexInterest: "Men",
    bio: "South suburb girl with big city dreams ✨ Love to laugh and keep it real.",
  },
  {
    name: "Simone",
    age: 26,
    ...
    sex: "Woman",
    sexInterest: "Men",
    bio: "Nurse, foodie, and beach lover 🌊 Chicago winters hit different but I make it work.",
  },
  {
    name: "Keisha",
    age: 30,
    ...
    sex: "Woman",
    sexInterest: "Men",
    bio: "God first, family always. Looking for something real not something temporary 🙏",
  },
  {
    name: "Brianna",
    age: 24,
    ...
    sex: "Woman",
    sexInterest: "Everyone",
    bio: "Artist and free spirit 🎨 Love deep talks, good music, and spontaneous adventures.",
  },
  {
    name: "Tiana",
    age: 27,
    ...
    sex: "Woman",
    sexInterest: "Men",
    bio: "Entrepreneur and mom boss 💼 Looking for a real partner in crime.",
  },
  {
    name: "Monique",
    age: 29,
    ...
    sex: "Woman",
    sexInterest: "Men",
    bio: "Wine, books, and good company 🍷 Swipe right if you can hold a real conversation.",
  },
  {
    name: "Destiny",
    age: 23,
    ...
    sex: "Woman",
    sexInterest: "Men",
    bio: "College grad, dog mom, gym addict 🐾 South suburbs raised, Chicago educated.",
  },
];
...
async function seedBots() {
  ...
  for (const bot of allBots) {
    try {
      ...
      console.log(
        `  ✅ ${bot.name} (${bot.sex}, ${bot.city}) — ${bot.autoLike ? "⚡ Auto-like" : "❤️ Like-back"}`,
      );
    } catch (error) {
  ...
  console.log(
    `   ⚡ Auto-likers: ${createdBots.filter((b) => b.autoLike).length}`,
  );
  console.log(
    `   ❤️  Like-back:  ${createdBots.filter((b) => !b.autoLike).length}`,
  );
  console.log(
    `   👨 Male:        ${createdBots.filter((b) => b.sex === "Man").length}`,
  );
  console.log(
    `   👩 Female:      ${createdBots.filter((b) => b.sex === "Woman").length}`,
  );
